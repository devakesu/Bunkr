...
import { Eye, EyeOff, Lock as LockIcon, Mail, Phone, User } from "lucide-react"; // Fixed Import
...
// Optimization: Defined outside component to prevent re-creation on render
const loginMethodProps = {
  ...
  email: {
    label: "Email",
    type: "email",
    placeholder: "cooked@attendance.com",
  },
  phone: {
    label: "Phone",
    type: "tel",
...
export function LoginForm({ className, ...props }: LoginFormProps) {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      // Performance: Removed artificial 1000ms delay
  ...
  return (
    <motion.div
      className={cn("flex flex-col gap-6 mt-6 sm:mt-10", className)}
      {...props}
      initial="hidden"
      animate="visible"
    ...
    >
      <form onSubmit={handleSubmit}>
            ...
            <motion.div className="grid gap-2" variants={itemVariants}>
              ...
              <div className="relative">
                <Input
                  ...
                  // Added bg-secondary/10 for better input visibility
        ...
        {/* Disclaimer Section - Accessibility Optimized */}
        <div className="mt-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-2 duration-700">
          ...
          <p className="text-xs text-muted-foreground/80 max-w-[320px] leading-relaxed text-center italic">
            Your <span className="text-foreground font-medium">EzyGo</span> credentials are safe. 
            We strictly <span className="text-foreground font-medium">do not read, store, or share</span> your login data. 
