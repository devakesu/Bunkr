...
- **Note**: Turbopack is disabled (`--no-turbopack`) because Serwist doesn't support it yet. We use Webpack for production builds to ensure PWA functionality works correctly.
